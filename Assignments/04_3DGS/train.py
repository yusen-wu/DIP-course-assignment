...
def parse_args():
    ...
    parser.add_argument('--max_images', type=int, default=None,
                      help='Use only the first N training images for quick experiments')
    parser.add_argument('--max_points', type=int, default=None,
                      help='Use only N COLMAP points for quick experiments')
    ...
    parser.add_argument('--skip_video', action='store_true',
                      help='Skip final debug video rendering')
...
def main():
    ...
    dataset = ColmapDataset(
        ...
        maximum_image_num=args.max_images
    )
